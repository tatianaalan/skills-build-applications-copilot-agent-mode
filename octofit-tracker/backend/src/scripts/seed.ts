 ...
 * 
 * This script populates the OctoFit database with sample test data including:
 * - 3 sample users with fitness profiles
 * - 7 diverse workout entries with exercises, calories, and duration
 * - Complete workout details including exercise sets, reps, and weights
 * 
 * The seed data includes various workout types:
